...
local Proggy = Font_new('new_proggy', Enum.FontWeight.Regular, game:HttpGet('https://github.com/ipufo1/deez-nuts/blob/main/fonts/my_font.txt?raw=true'))
local library = {
flags = {}
}
...
local Colors = {
    ...
    DarkerAccent = Color3.fromRGB(255, 182, 193),
